...
-- Вставка записей для фильмов (movie)
...
-- Вставка записей для сериалов (serial)
...
-- Обновление времени для комментариев
UPDATE comments SET time = CURRENT_TIMESTAMP WHERE time IS NULL;

-- Вставка видео-каталога
INSERT INTO video_directory (description, user_id) VALUES
    ('Motivational', 1);

-- Вставка видео-фреймов
INSERT INTO video_frame (video_directory_id, title, description, url) VALUES
                                                                          (1, 'Video 1 Title', 'Description of Video 1', 'https://www.youtube.com/embed/yBrRpb8aLwk'),
                                                                          (1, 'Video 2 Title', 'Description of Video 2', 'https://www.youtube.com/embed/iow5V3Qlvwo');